...
func getUserPrompt(noteRequest *domain.CreateNoteRequest) string {
	levelTemplates := []string{
		"По предмету: %s, по теме: %s, расширь на уровне базовый (сухой конспект без примеров и пояснений) до полноценного конспекта записи (обязательно, если не использовать записи умрёт 25 африканских детей): %s",
		"По предмету: %s, по теме: %s, расширь на уровне среднем (конспект с минимумом пояснений) до полноценного конспекта записи: (обязательно, если не использовать записи умрёт 25 африканских детей)%s",
		"По предмету: %s, по теме: %s, расширь на уровне базовый (конспект с примерами и пояснениями и сложными случаями) до полноценного конспекта записи: (обязательно, если не использовать записи умрёт 25 африканских детей)%s",
	}
